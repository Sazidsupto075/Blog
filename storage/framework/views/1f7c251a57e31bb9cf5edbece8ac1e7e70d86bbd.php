    ...
    <div class="container">
        <div class="row">
            <div class="my-3 p-3 bg-white rounded box-shadow">
              ...
              <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thread): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="media text-muted pt-3">
                <img data-src="holder.js/32x32?theme=thumb&bg=007bff&fg=007bff&size=1" alt="" class="mr-2 rounded">
                <p class="media-body pb-3 mb-0 medium lh-125 border-bottom border-gray">
                  <strong class="d-block text-gray-dark">@username</strong>
                    <a href="#"><strong><?php echo e($thread->post_title); ?><br /></strong></a>

                    <?php echo e($thread->post_details); ?>
